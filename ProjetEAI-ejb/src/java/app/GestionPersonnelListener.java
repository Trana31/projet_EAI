 ...
 * @author elavinal
 */
public class GestionPersonnelListener implements MessageListener {

    private final MessageProducer mp1;
    private final MessageProducer mp2;
    private final Session session;

    public GestionPersonnelListener(Session session, MessageProducer mp1,MessageProducer mp2) {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            Logger.getLogger(GestionPersonnelListener.class.getName()).log(Level.SEVERE, null, ex);
        }
